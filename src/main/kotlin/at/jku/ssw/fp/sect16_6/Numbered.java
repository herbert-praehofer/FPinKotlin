 ...
 */
public class Numbered<A extends Comparable<A>> implements Comparable<Numbered<A>> {

  /**
   * Comparator for numbered values by first comparing the number and then the value.
   */
  private Comparator<Numbered<A>> comparator = Comparator.<Numbered<A>>comparingInt(numA -> numA.n)
      .thenComparing(numA -> numA.value);
